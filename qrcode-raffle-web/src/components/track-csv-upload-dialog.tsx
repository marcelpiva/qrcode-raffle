...
interface TrackCsvUploadDialogProps {
  open: boolean
...
export function TrackCsvUploadDialog({ open, onOpenChange, trackId, onSuccess }: TrackCsvUploadDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`/api/tracks/${trackId}/attendance`, {
        method: 'POST',
        body: formData,
      })
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Importe um arquivo CSV com a lista de presenças da trilha
          </DialogDescription>
        </DialogHeader>
